...
/**
 * @extends ServiceEntityRepository<Pointderelais>
 *
...
//    /**
//     * @return Pointderelais[] Returns an array of Pointderelais objects
//     */
...
//    public function findOneBySomeField($value): ?Pointderelais
//    {
//        return $this->createQueryBuilder('p')
//            ->andWhere('p.exampleField = :val')
//            ->setParameter('val', $value)
